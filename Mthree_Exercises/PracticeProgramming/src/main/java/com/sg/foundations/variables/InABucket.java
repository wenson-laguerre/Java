...
public class InABucket {
    public static void main(String[] args) {
        ...
        System.out.println("The tea cup for pigs weigh: "+weightOfTeacupPig+" kgs");
        System.out.println("i found "+grainsOfSand+" grains of sand in my shoes");
    }
}
